...
@ResponseStatus(value= HttpStatus.BAD_REQUEST, reason="O saldo da conta de origem não pode ser negativo.")  // 404
public class NegativeSourceBalanceException extends RuntimeException {
	...
	public NegativeSourceBalanceException() {
		super("O saldo da conta de origem não pode ser negativo.");
	}
